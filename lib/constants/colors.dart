...
class AppColors {
  ...
  static final Color iconColor1 = Color.fromARGB(255, 249, 249, 249);
  static final Color iconColor2 = const Color(0xFFfcab88);
  static final Color paraColor = const Color(0xFF8f837f);
  static final Color buttonBackgroundColor = Color(0xFFFDBF30);
  ...
  static Color kBackground = Color(0xFFF5F5F5);
  static Color kPrimary = Color(0xFFFDBF30);
}
